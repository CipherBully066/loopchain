...
"""gRPC service for Score Outer Service"""
...
from loopchain.baseservice import ScoreResponse, ObjectManager, PeerScore
...
class ScoreOuterService(loopchain_pb2_grpc.ContainerServicer):
    ...
    def score_service(self):
        return ObjectManager().score_service
    ...
    def __handler_stop(self, request, context):
        ...
        self.score_service.service_stop()
        return loopchain_pb2.Message(code=message_code.Response.success)
