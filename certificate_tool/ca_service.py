...
class CAService:
    ...
    def __init__(self, default_dir=None, password=None, is_ca=True):
        self.__PEER_CERT = {}
    ...
    def generate_ca_cert(self, cn, ou, o, expire_period=None, password=None):
        ...
        self.generate_self_signed_certificate(cn, ou, o, expire_period, password, serial_number, self.__CA_PATH)

    def generate_self_signed_certificate(self, cn, ou, o, expire_period,
                                         password=None, serial_number=None, cert_path=None):
        if cert_path is None:
            cert_path = self.__CA_PATH
        ...
        self.__save(cert_path, cert_pem, pri_pem)
